...
namespace Tekton.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register(RegisterModel model)
        {
            ...
            {
                //validar que correo tenga dominio @tektonlabs.com
                if (!model.UserName.ToLowerInvariant().EndsWith("@tektonlabs.com"))
                {
                    ModelState.AddModelError("", "El correo debe tener dominio @tektonlabs.com");
                    return View(model);
                }
